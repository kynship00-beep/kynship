-- ============================================
-- kynship - Supabase Database Schema
-- ============================================
...
-- 5. pages-images (public)

-- ============================================
-- 13. REALTIME SETUP (PARTIAL)
-- ============================================

-- ملاحظة: تم تفعيل Realtime للجداول التالية في هذا الملف:
-- - site_settings (للإعدادات)
-- - products (للمنتجات)
-- - orders (للطلبات)
--
-- الجداول المتبقية سيتم تفعيلها في ملف realtime-setup.sql:
-- - pages_content (لمحتوى الصفحات)
-- - faq (للأسئلة الشائعة)

-- ============================================
-- DONE! kynship database schema is ready
-- ============================================
