    ...
    try {
      ...
      if (data && data.length > 0) {
        ...
        data.forEach((item: any) => {
          ...
          // Debug logging
          console.log('Processing setting:', item.key, 'Value:', value, 'Type:', typeof value)
          ...
          switch (item.key) {
            ...
            case 'hero_background':
              ...
              if (typeof value === 'string') {
                ...
                console.log('Set URL setting:', item.key, 'to:', value)
              } else {
                console.log('Invalid URL value for:', item.key, 'Value:', value)
              }
              break
            ...
            case 'secondary_color':
              ...
              if (typeof value === 'string' && value.startsWith('#')) {
                ...
                settingsObj[item.key] = defaultSettings[item.key as keyof typeof defaultSettings]
              }
              break
