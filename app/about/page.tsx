...
export const metadata = {
  title: 'من نحن - kynship',
  description: 'تعرف على شركة kynship وخبرتنا في مجال الألوميتال',
}
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-3xl font-bold mb-6">kynship</h2>
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                نحن شركة متخصصة في تصنيع وتركيب مطابخ وأبواب وشبابيك الألوميتال بأعلى معايير الجودة.
                تأسست شركتنا kynship منذ أكثر من 15 عامًا، ونفخر بخدمة آلاف العملاء في جميع أنحاء مصر.
              </p>
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
